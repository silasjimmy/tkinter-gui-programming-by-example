...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 09:37:23 2020
...
cards_folder = os.path.join(assets_folder, 'cards')
...
class Card:
    ...
    def __init__(self, suit, value):
        self.suit = suit
        self.value = value
        self.img = tk.PhotoImage(file=cards_folder + '/' + self.suit + self.value + ".png")
    ...
    def get_back_file(cls):
        cls.back = tk.PhotoImage(file=cards_folder + "/back.png")
        return cls.back
...
class GameScreen(tk.Tk):
    ...
    def display_table(self, hide_dealer=True, table_state=None):
        ...
        self.tabletop_image = tk.PhotoImage(file=cards_folder + "/tabletop.png")
